...
%%%%%%%
\textbf{Question :}
Show that if x has a Rayleigh density with parameter $\alpha$ and  y = b+cx$^2$, then {\ $\sigma$$_y ^2$\ }= 4c$^2$$\alpha$$^4$
...
\textbf{Solution :}
     ...
     \begin{align}
     	...
     	&= \frac{1}{2\sigma^2} \int_{-\infty}^{\infty} \mydet{x}^{n+1}e^\frac{-x^2}{2\sigma^2} \,dx
     \end{align}
