...
void gaussian(char *str1,int len)
{
int i,j;
double temp;
FILE *fp;
...
void new_type(char *str1,char *str2 ,char *str3 , int len)
{
int i,j;
double temp;
FILE *fp_3;
...
double k = 0 ;
//Generate numbers
while(fscanf(fp_1,"%lf",&a)!= EOF && fscanf(fp_2,"%lf",&b)!= EOF)
{
//going through lines
i++ ,
k = a*a + b*b ;
...
void new_type_root(char *str1,char *str2, int len)
{
int i,j;
double temp;
FILE *fp_1;
